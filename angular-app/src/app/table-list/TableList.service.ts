...
import { Package } from '../org.example.mynetwork';
import 'rxjs';
...
export class TableListService {
  ...
  public getAsset(id: any): Observable<Package> {
  ...
  public deleteAsset(id: any): Observable<Package> {
