...
public class Condition {
		...
		public static List<Condition> getConditionFromRuleID(int i) {
			/*Requete get conditions */
			List<Condition> conditions = new ArrayList<Condition>();
			Condition HightValueTemperature = new Condition();
			HightValueTemperature.setField("temperatureValue");
			HightValueTemperature.setOperator(Condition.Operator.GREATER_THAN_OR_EQUAL_TO);
			HightValueTemperature.setValue(2.0);
